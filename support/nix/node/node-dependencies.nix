...
let
  sources = {
    "@types/d3-7.1.0" = {
      ...
      version = "7.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/d3/-/d3-7.1.0.tgz";
        sha512 = "gYWvgeGjEl+zmF8c+U1RNIKqe7sfQwIXeLXO5Os72TjDjCEtgpvGBvZ8dXlAuSS1m6B90Y1Uo6Bm36OGR/OtCA==";
      };
    };
    ...
    "fast-fuzzy-1.11.1" = {
      ...
      version = "1.11.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/fast-fuzzy/-/fast-fuzzy-1.11.1.tgz";
        sha512 = "FaO8kAsdAqV0SOBbLelpuBNar4C6lUS82OqDlM6Y/I0Q9joMmxAxll8AMrfTLp82rRuZj/2+BzFZgOHA18vN6A==";
      };
    };
    "graphemesplit-2.4.4" = {
      name = "graphemesplit";
