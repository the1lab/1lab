...
% Notation for lambda abstractions.
\newcommand{\lam}[2]{\lambda #1.\ #2}

% Notation for paths, the interval, and its operations.
\newcommand{\is}{\equiv}
\newcommand{\PathP}[3]{\operatorname{PathP}\ {#1}\ {#2}\ {#3}}
\newcommand{\Path}[3]{\operatorname{Path}\ {#1}\ {#2}\ {#3}}
\newcommand{\Square}[4]{\operatorname{Square}\ {#1}\ {#2}\ {#3}\ {#4}}
...
\newcommand{\transport}[2]{\operatorname{transport}(#1,~ #2)}
\newcommand{\transp}[3]{\operatorname{transp}(#1,~ #2,~ #3)}
\newcommand{\Partial}[2]{\operatorname{Partial}(#1,~ #2)}
