...
Square→Cone
  ...
  → (p1 : Hom P A) (p2 : Hom P B)
    (f : Hom A C) (g : Hom B C)
  → f ∘ p1 ≡ g ∘ p2
  → Cone (cospan→cospan-diagram x y {C = Cat} f g)
...
Square→Cone p1 p2 f g square .commutes {cs-a} {cs-a} _ = idl _
Square→Cone p1 p2 f g square .commutes {cs-a} {cs-c} _ = refl
Square→Cone p1 p2 f g square .commutes {cs-b} {cs-b} _ = idl _
Square→Cone p1 p2 f g square .commutes {cs-b} {cs-c} _ = sym square
Square→Cone p1 p2 f g square .commutes {cs-c} {cs-c} _ = idl _
