...
```agda
  ...
  make-algebra-colimit colim apex-coalg comm = coem-colim where
  ...
  Forget-lift-colimit colim-over = to-colimit $ to-is-colimit $ make-algebra-colimit
