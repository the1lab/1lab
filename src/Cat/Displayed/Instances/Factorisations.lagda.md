...
<details>
<summary>The only interesting thing to note about the coherence data
here is that we can reindex `Interpolant`{.Agda}s over identifications
between squares without disturbing the middle map.</summary>
