...
Just as the [functors] between precategories $\cA$ and $\cB$ form a
precategory $[\cA , \cB]$, the [[displayed functors]] between [[displayed
precategories]] $\cE$ and $\cF$  over $\cA$ and $\cB$ form a [[displayed
precategory]] $[\cE, \cF]$ over $[\cA, \cB]$, with [[displayed natural
...
that an object over $F$ is a displayed functor over $F$, and a displayed
