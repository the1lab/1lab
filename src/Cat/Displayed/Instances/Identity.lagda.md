...
```agda
IdD-discrete-fibration : is-discrete-fibration IdD
IdD-discrete-fibration .is-discrete-fibration.fibre-set _ = hlevel 2
IdD-discrete-fibration .is-discrete-fibration.cart-lift _ _ = hlevel 0
```
