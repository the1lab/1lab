...
\liesover \cB$ be [[categories displayed over|displayed category]] its
endpoints. If $F' : \cE \to_F \cF$ (resp. $F'\inv : \cF \to_{F\inv}
\cE$) are [[displayed functors]] in a [[displayed adjunction]] $F'
\dashv F'\inv$, we say it is a **displayed adjoint equivalence**, or
simply **equivalence of displayed categories**, if its unit and counit
maps are [[displayed natural isomorphisms]].
...
```agda
    ...
    F'⁻¹ .F-id' {x} {x'} = ℰ.begin[]
      ff'⁻¹ (ffx' ℱ.∘' ⌜ ℱ.id' ℱ.∘' ftx' ⌝) ℰ.≡[]⟨ apd! (ℱ.idl' ftx') ⟩
      ff'⁻¹ ⌜ ffx' ℱ.∘' ftx' ⌝              ℰ.≡[]⟨ apd! (f*x'-iso.invr') ⟩
      ff'⁻¹ ⌜ ℱ.id' ⌝                       ℰ.≡[]˘⟨ apd¡ (F' .F-id') ⟩
      ff'⁻¹ (F'.₁' ℰ.id')                   ℰ.≡[]⟨ η[] ℰ.id' ⟩
      ℰ.id'                                 ℰ.∎[]
      where
        open Σ (eso' x') renaming (fst to f*x' ; snd to f*x'-iso)
    ...
    F'⁻¹ .F-∘' {a' = x'} {y'} {z'} {f'} {g'} = ff[]→faithful[] F' ff' $ ℱ.begin[]
      ...
      ffz' ℱ.∘' ⌜ (f' ℱ.∘' g') ℱ.∘' ftx' ⌝                                                ℱ.≡[]˘⟨ apd¡ (ℱ.assoc' f' g' ftx') ⟩
      ffz' ℱ.∘' f' ℱ.∘' ⌜ g' ℱ.∘' ftx' ⌝                                                  ℱ.≡[]˘⟨ apd¡ (ℱ.idl' (g' ℱ.∘' ftx')) ⟩
      ffz' ℱ.∘' f' ℱ.∘' ⌜ ℱ.id' ⌝ ℱ.∘' g' ℱ.∘' ftx'                                       ℱ.≡[]˘⟨ apd¡ (f*y'-iso .ℱ.invl') ⟩
      ffz' ℱ.∘' f' ℱ.∘' ⌜ (fty' ℱ.∘' ffy') ℱ.∘' g' ℱ.∘' ftx' ⌝                            ℱ.≡[]˘⟨ apd¡ (ℱ.assoc' fty' ffy' (g' ℱ.∘' ftx')) ⟩
      ffz' ℱ.∘' ⌜ f' ℱ.∘' fty' ℱ.∘' (ffy' ℱ.∘' g' ℱ.∘' ftx') ⌝                            ℱ.≡[]⟨ apd! (ℱ.assoc' f' fty' (ffy' ℱ.∘' g' ℱ.∘' ftx'))⟩
      ffz' ℱ.∘' (f' ℱ.∘' fty') ℱ.∘' (ffy' ℱ.∘' g' ℱ.∘' ftx')                              ℱ.≡[]⟨ ℱ.assoc' ffz' (f' ℱ.∘' fty') (ffy' ℱ.∘' g' ℱ.∘' ftx') ⟩
      ⌜ ffz' ℱ.∘' f' ℱ.∘' fty' ⌝ ℱ.∘' (ffy' ℱ.∘' g' ℱ.∘' ftx')                            ℱ.≡[]˘⟨ apd¡ (ε[] (ffz' ℱ.∘' f' ℱ.∘' fty')) ⟩
      F'.₁' (ff'⁻¹ (ffz' ℱ.∘' f' ℱ.∘' fty')) ℱ.∘' ⌜ ffy' ℱ.∘' g' ℱ.∘' ftx' ⌝              ℱ.≡[]˘⟨ apd¡ (ε[] (ffy' ℱ.∘' g' ℱ.∘' ftx')) ⟩
