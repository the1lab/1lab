...
The 1Lab project **does not accept** contributions generated by, or
created through the use of, tools based on large language models (LLMs),
including, but not limited to, tools like Claude (incl. Claude Code),
ChatGPT, Gemini, DeepSeek, and Copilot.

We welcome all human contributions, but please understand that the 1Lab has a
